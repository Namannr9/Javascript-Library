...
function Modal(cref) {
    ...
    headerDivision.style.background = "#3561E0";
    ...
    footerDivision.style.background = "#566573";
    footerDivision.style.left = "0";
    footerDivision.style.right = "0";
    footerDivision.style.color = "#FFFFFF";
...
$$$.accordianHeadingClicked = function (accordianIndex, panelIndex) {
    ...
    $$$.model.accordians[accordianIndex].panels[panelIndex + 1].style.border = "1px solid black";
...
$$$.toAccordian = function (accord) {
    ...
    for (x = 0; x < children.length; x++) {
        if (children[x].nodeName == "H3") {
            ...
            children[x].style.border = "1px solid black";
            ...
            else children[x].style.background = "#81A0EA";
        }
